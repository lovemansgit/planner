...
function Row({
  ...
  return (
    ...
    >
      ...
      {/* R6.4 + Phase 12.2 cosmetic: Consignee · District · Emirate · Telephone
          ...
          District + Emirate suffice, and it forced the table's horizontal scroll);
          the underlying addressLine projection is unchanged — just not rendered. */}
