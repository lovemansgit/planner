...
function Row({
  ...
  return (
    ...
    >
      ...
      {/* R6.4 + Phase 12.2: Consignee · District · City · Telephone form ONE
          click target to the consignee detail page. The name cell is the
          keyboard-focusable primary link; the rest are mouse targets (tabIndex
          -1) so the block is one logical stop. Telephone is plain text inside the
          link — NOT a tel: link. The Address column was dropped (Love: District +
          City suffice, and it forced the table's horizontal scroll); the "City"
          header binds the EMIRATE value (relabel lane). addressLine + emirate
          projections are unchanged — Address is simply not rendered. */}
