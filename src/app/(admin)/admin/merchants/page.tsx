...
// admin surface).
//
// Direction-B+ skin (Phase 12 · Batch ADM-2):
//   - bg-surface-primary; text-navy; var(--color-...) tokens
//   - shared shellClass content width (Batch A) so header + body share a left edge
//   - shared <HeroCount> floating B+ card for the count (Batch H), mono tabular figure
//   - sentence-case headers, pills, and B+ buttons throughout
//
  ...
  return (
    <main className="min-h-screen bg-surface-primary text-navy font-sans">
      <div className={shellClass("py-16")}>
        ...
        <HeroCount count={merchants.length} label={countLabel} />
