...
- [Day 7 EOD handoff (scaffold)](handoffs/day-7-eod.md) — structure ready; fill empty sections at end of day before the file's PR. Sections 1–3 (durable) + 10 (acknowledge protocol) pre-populated.
