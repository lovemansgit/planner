...
- [createTask retry creates duplicates](followup_createtask_idempotency.md) — **Day-14 blocker**. SF sandbox does NOT dedupe by customerOrderNumber (probe 2026-04-29). Harden via Idempotency-Key probe or disable POST retry pre-pilot
