...
- [Bag tracking MVP design](decision_bag_tracking_mvp.md) — hybrid cache + read-through with 5-min TTL; 5-state taxonomy reconciled against SF response shape in B-1; emit-none on cache reads; bag-tracking-enabled flag derives from inbound webhook payload
