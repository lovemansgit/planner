...
- [Phase 1.5 admin cross-tenant — Phase 2 follow-up surface area](followup_phase_1_5_search_affordance_phase_2.md) — three Phase-2 lanes deferred from Day-19 Phase 1.5 code-PR: global search affordance (Lane A); cursor pagination at 10k+ rows (Lane B); cross-tenant action capability / Phase 1.6 (Lane C). Each lane has a defined trigger + scope sketch. Sequencing: A → B → C if multiple lanes co-land.
