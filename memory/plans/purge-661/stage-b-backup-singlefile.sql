...
SELECT restore_seq, tbl, stmt FROM (
  SELECT 1 AS restore_seq, 'suitefleet_regions' AS tbl,
         format('INSERT INTO %I (%s) SELECT %s FROM jsonb_populate_record(NULL::%I, %L::jsonb);',
                'suitefleet_regions', c.cols, c.cols, 'suitefleet_regions', to_jsonb(x)::text) AS stmt
  FROM suitefleet_regions x
  CROSS JOIN LATERAL (SELECT string_agg(quote_ident(attname), ', ' ORDER BY attnum) AS cols
                      FROM pg_attribute
                      WHERE attrelid = 'suitefleet_regions'::regclass AND attnum > 0 AND NOT attisdropped AND attgenerated = '') c
  WHERE x.client_id NOT IN ('transcorpsb', 'transcorp', 'transcorpuae', 'transcorpqatar')   -- 0024:120 — junk regions (parents of tenants); deleted in Stage 3
  UNION ALL
  ...
  WHERE x.id IN (SELECT tenant_id FROM tgt)   -- 0001:65 — the 54 target tenants
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0001:105 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0001:139 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0001:193 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0001:218 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0012:157 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0013:148 tenant_id PK -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0018:74 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0004:69 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0014:124 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0016:152 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0009:134 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0014:171 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0015:136 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0015:212 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0006:125 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0007:109 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0008:139 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0011:165 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0023:101 tenant_id -> tenants CASCADE
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0032:42 tenant_id -> tenants RESTRICT (Blocker B)
  UNION ALL
  ...
  WHERE x.tenant_id IN (SELECT tenant_id FROM tgt)   -- 0002:45 tenant_id -> tenants CASCADE (Blocker A — RULE)
