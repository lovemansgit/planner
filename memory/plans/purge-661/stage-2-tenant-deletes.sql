-- PURGE #661 — STAGE 2: TENANT DELETES (one transaction). Target: qdotjmwqbyzldfuxphei (PROD).
-- Authorization: separate named Love clear, AFTER Stage-1 child deletes are committed + verified.

-- ============================================================
-- STAGE 2 — DRY RUN (ends ROLLBACK)
-- ============================================================
BEGIN;
...
-- ============================================================
-- STAGE 2 — EXECUTE (ends COMMIT — runs ONLY on Love's named clear)
-- ============================================================
BEGIN;
