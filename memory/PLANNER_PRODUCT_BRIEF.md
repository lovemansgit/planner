...
| Public marketing landing route ownership: does the public landing take `/` (displacing the §3.3.9 authenticated operator landing to a post-login home / redirect) or live on a separate route with `/` staying the authed home? (v1.32 — blocks the landing-page build) | Pending Love's ruling |
